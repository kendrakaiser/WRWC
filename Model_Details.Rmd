...
knitr::include_graphics(file.path(fig_dir,"ModelWorkflow_details.png"))
```
...
knitr::include_graphics(file.path(fig_dir,"Div.abv.Hailey.png")) # change to total diversions
```
...
knitr::include_graphics(c(file.path(fig_dir,"BWB_modelFit.png"), file.path(fig_dir,"BWB_CMmodelFit.png")))
```
...
knitr::include_graphics(c(file.path(fig_dir,"BWS_modelFit.png"), file.path(fig_dir,"BWS_CMmodelFit.png")))
```
...
knitr::include_graphics(c(file.path(fig_dir,"SC_modelFit.png"), file.path(fig_dir,"SC_CMmodelFit.png")))
```
...
knitr::include_graphics(c(file.path(fig_dir,"CC_modelFit.png"), file.path(fig_dir,"CC_CMmodelFit.png")))
```
...
knitr::include_graphics(file.path(fig_dir,"Diversions_modelFit.png"))
```
...
knitr::include_graphics(file.path(fig_dir,"SilverCreek_Diversions_modelFit.png"))
```
...
knitr::include_graphics(file.path(fig_dir,"correlation_matrix.png"))
```
...
knitr::include_graphics(file.path(fig_dir,"sampled_volumes.png"))
```
...
knitr::include_graphics(file.path(fig_dir,"CM_summary.png"))
```
...
The following figure is an example model output figure for the Big Wood, you can see the prediction interval is quite narrow around the mean (blue) and in comparison to the year with the most similar center of mass (green)
...
knitr::include_graphics(file.path(fig_dir,"BigWood_Hailey_Simulation.png"))
```

```{r, BWS Simulatione, echo=FALSE, fig.cap="Simulated flows on the Big Wood River at Stanton Crossing", fig.aling="left", out.width = '100%', fig.pos='H'}
knitr::include_graphics(file.path(fig_dir,"BigWood_Stanton_Simulation.png"))
```

```{r, SC Simulation, echo=FALSE, fig.cap="Simulated flows on Silver Creek", fig.aling="left", out.width = '100%', fig.pos='H'}
knitr::include_graphics(file.path(fig_dir,"Silver_creek_Simulation.png"))
```

```{r, CC Simulation, echo=FALSE, fig.cap="Simulated flows on Camas Creek", fig.aling="left", out.width = '100%', fig.pos='H'}
knitr::include_graphics(file.path(fig_dir,"Camas_creek_Simulation.png"))
```
