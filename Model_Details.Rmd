...
### Agrimet
A specific RNRCS package is needed to download the full time series of AgriMet Data, to install this package the following code needs to be run.
...
knitr::include_graphics(file.path(params$fig_dir_mo, "Div.abv.Hailey.png"))
