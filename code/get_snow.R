...
grab_ws_snow=function(ws_ids, dates, metric){
  dates=as.Date(dates)
  ...
  if(!metric %in% snodasMetrics$metric){
  ...
  #######3worker function for doing actual snodasing
  grab_ws_snow_worker = function(ws_ids, date, metric, metricDefinitions=snodasMetrics){
