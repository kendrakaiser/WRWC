...
data_dir <-  '~/Desktop/WRWC-model-out/data'
git_dir <<- '~/github/WRWC'
...
knitr::include_graphics(file.path(params$fig_dir_mo, "BWS_Simulation.png"))
```

```{r, sc sim, echo=FALSE, fig.cap="Simulated volumes", fig.aling="left", out.width = '100%', fig.pos='H'}
knitr::include_graphics(file.path(params$fig_dir_mo,"SC_Simulation.png"))
```

```{r, cc sim, echo=FALSE, fig.cap="Simulated volumes", fig.aling="left", out.width = '100%', fig.pos='H'}
knitr::include_graphics(file.path(params$fig_dir_mo,"CC_Simulation.png"))
```
