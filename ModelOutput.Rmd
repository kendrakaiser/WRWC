...
The NRCS Water Supply Report can be found here: https://www.wcc.nrcs.usda.gov/ftpref/states/id/webftp/wsor/2021/borid121.pdf
...
```{r, volume tables, echo=FALSE, out.width = '100%', fig.show="hold"}
...
Mean simulated streamflow is shown in the solid blue line, mean daily streamflow is shown in black and the 95% confidence interval around the simulations is shown in the shaded gray area.
